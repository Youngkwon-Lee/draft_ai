...
export default function UserExerciseRoutinesPage() {
  ...
  return (
    <div className="container max-w-6xl mx-auto py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold">나의 운동 루틴</h1>
          <p className="text-muted-foreground mt-2">
            나의 운동 루틴을 확인하고 관리하세요.
          </p>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    {routine.lastCompleted && (
                      <div className="flex items-center gap-1">
                        ...
                        <span>마지막 완료: {routine.lastCompleted}</span>
                      </div>
                    )}
                    {routine.nextScheduled && (
                      <div className="flex items-center gap-1">
                        <Calendar className="h-4 w-4" />
                        <span>다음 예정: {routine.nextScheduled}</span>
                      </div>
                    )}
                  </div>
